...
export const gu: LanguageStrings = {
  ...
  otpResendFailed: (err: string) => `OTP ફરીથી મોકલી શકાયો નહીં: ${err}`,
  otpVerified: 'ફોન સફળતાપૂર્વક ચકાસાયો!',
  otpVerifyFailed: (err: string) => `OTP ચકાસણી નિષ્ફળ: ${err}\nકૃપા કરીને ફરીથી પ્રયાસ કરો:`,
  ...
  supportMessage: (phone: string) => `💬 મદદ જોઈએ છે?\n\nઅમને કૉલ કરો: ${phone}\n\nઅમે તમારી મદદ માટે અહીં છીએ. 🙏`,
  ...
  regularFareConfirm: (fare: number, area: string) => `🛺 *${area}* સુધી ઓટો\n💰 આશરે *₹${fare}*\n\nબુક કરી દઉં?`,
