...
export const kn: LanguageStrings = {
  ...
  transitTicketButton: '🎫 ಮೆಟ್ರೋ/ಬಸ್ ಟಿಕೆಟ್',
  chooseTransitMode: '🎫 ನೀವು ಏನನ್ನು ಬುಕ್ ಮಾಡಲು ಬಯಸುತ್ತೀರಿ?',
  transitMetro: '🚇 ಮೆಟ್ರೋ',
  transitBus: '🚌 ಬಸ್',
  transitSubway: '🚊 ಉಪನಗರ ರೈಲು',
  transitUnavailable: 'ನಿಮ್ಮ ನಗರದಲ್ಲಿ ಇನ್ನೂ ಟಿಕೆಟ್ ಬುಕಿಂಗ್ ಲಭ್ಯವಿಲ್ಲ.',
  enterBoardingStation: (mode: string) => `ನೀವು ಯಾವ ${mode} ನಿಲ್ದಾಣದಿಂದ ಹತ್ತುತ್ತೀರಿ?`,
  enterDropStation: (mode: string) => `ನೀವು ಯಾವ ${mode} ನಿಲ್ದಾಣದಲ್ಲಿ ಇಳಿಯುತ್ತೀರಿ?`,
  selectBoardingStation: 'ನಿಮ್ಮ ಹತ್ತುವ ನಿಲ್ದಾಣವನ್ನು ಆಯ್ಕೆಮಾಡಿ:',
  selectDropStation: 'ನಿಮ್ಮ ಗಮ್ಯಸ್ಥಾನದ ನಿಲ್ದಾಣವನ್ನು ಆಯ್ಕೆಮಾಡಿ:',
  noStationsFound: (query: string) => `"${query}" ಗಾಗಿ ಯಾವುದೇ ನಿಲ್ದಾಣ ಸಿಗಲಿಲ್ಲ. ಬೇರೆ ಹೆಸರು ಪ್ರಯತ್ನಿಸಿ:`,
  sameStationChosen: 'ಹತ್ತುವ ಮತ್ತು ಇಳಿಯುವ ನಿಲ್ದಾಣ ಒಂದೇ ಆಗಿರಲು ಸಾಧ್ಯವಿಲ್ಲ. ಬೇರೆ ಆಯ್ಕೆಮಾಡಿ:',
  chooseQuantity: 'ಎಷ್ಟು ಟಿಕೆಟ್‌ಗಳು ಬೇಕು?',
  ticketsCount: (n: number) => `${n} ಟಿಕೆಟ್`,
  invalidQuantity: (max: number) => `ದಯವಿಟ್ಟು 1 ರಿಂದ ${max} ರ ನಡುವೆ ಟಿಕೆಟ್ ಆಯ್ಕೆಮಾಡಿ.`,
  searchingTickets: '🔎 ದರವನ್ನು ಪರಿಶೀಲಿಸಲಾಗುತ್ತಿದೆ...',
  noTicketsAvailable: 'ಈ ಮಾರ್ಗಕ್ಕೆ ಸದ್ಯಕ್ಕೆ ಟಿಕೆಟ್ ಲಭ್ಯವಿಲ್ಲ. ಮರುಪ್ರಾರಂಭಿಸಲು "cancel" ಕಳುಹಿಸಿ.',
  ticketSummary: (from: string, to: string, fare: number, qty: number) =>
    `🎫 *${from}* → *${to}*\n\n💰 ₹${fare} · ${qty} ಟಿಕೆಟ್`,
  payNow: (fare: number) => `💳 ₹${fare} ಪಾವತಿಸಿ`,
  payPrompt: 'ಪಾವತಿಸಲು ಕೆಳಗೆ ಟ್ಯಾಪ್ ಮಾಡಿ. ಪಾವತಿ ಆದ ತಕ್ಷಣ ನಿಮ್ಮ ಟಿಕೆಟ್ ಇಲ್ಲಿಯೇ ಕಳುಹಿಸುತ್ತೇನೆ.',
  awaitingPayment: '⏳ ನಿಮ್ಮ ಪಾವತಿಗಾಗಿ ಕಾಯಲಾಗುತ್ತಿದೆ...',
  ticketConfirmed: '✅ *ಟಿಕೆಟ್ ದೃಢಪಟ್ಟಿದೆ!*',
  ticketLabel: (ticketNo: string) => `🎫 ಟಿಕೆಟ್ ${ticketNo}`,
  ticketValidTill: (till: string) => `⏰ ${till} ವರೆಗೆ ಮಾನ್ಯ`,
  ticketQrCaption: (from: string, to: string) => `🎫 ${from} → ${to}\nಗೇಟ್‌ನಲ್ಲಿ ಈ QR ತೋರಿಸಿ.`,
  ticketQrFallback: 'QR ಚಿತ್ರ ರಚಿಸಲಾಗಲಿಲ್ಲ. ಗೇಟ್‌ನಲ್ಲಿ ಈ ಕೋಡ್ ತೋರಿಸಿ:',
  paymentFailed: '❌ ಪಾವತಿ ವಿಫಲವಾಗಿದೆ. ಯಾವುದೇ ಹಣ ಕಡಿತವಾಗಿಲ್ಲ. ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಲು "book" ಕಳುಹಿಸಿ.',
  paymentTimedOut: '⏰ ಸಮಯಕ್ಕೆ ಪಾವತಿ ದೃಢೀಕರಣ ಸಿಗಲಿಲ್ಲ. ಹಣ ಕಡಿತವಾಗಿದ್ದರೆ, ನಿಮ್ಮ ಟಿಕೆಟ್ "ನನ್ನ ಟಿಕೆಟ್‌ಗಳು" ನಲ್ಲಿ ಕಾಣಿಸುತ್ತದೆ.',
  myTicketsButton: '🎫 ನನ್ನ ಟಿಕೆಟ್‌ಗಳು',
  noActiveTickets: 'ನಿಮ್ಮ ಬಳಿ ಯಾವುದೇ ಸಕ್ರಿಯ ಟಿಕೆಟ್ ಇಲ್ಲ.',
  cancelTicket: '❌ ಟಿಕೆಟ್ ರದ್ದುಮಾಡಿ',
  ticketCancelled: '✅ ಟಿಕೆಟ್ ರದ್ದಾಗಿದೆ. ಮರುಪಾವತಿ ನಿಮ್ಮ ಮೂಲ ಪಾವತಿ ವಿಧಾನಕ್ಕೆ ಜಮೆಯಾಗುತ್ತದೆ.',
  ticketCannotCancel: 'ಈ ಟಿಕೆಟ್ ಅನ್ನು ಇನ್ನು ರದ್ದುಮಾಡಲಾಗದು.',

  // Multimodal journeys
  journeyOptionsHeader: '🧭 ಅಲ್ಲಿಗೆ ತಲುಪಲು ಕೆಲವು ಮಾರ್ಗಗಳು:',
  transitOptionsLabel: '🚇 ಸಾರ್ವಜನಿಕ ಸಾರಿಗೆ ಆಯ್ಕೆಗಳು',
  noJourneysFound: 'ಈ ಪ್ರಯಾಣಕ್ಕೆ ಸಾರ್ವಜನಿಕ ಸಾರಿಗೆ ಮಾರ್ಗ ಸಿಗಲಿಲ್ಲ.',
  bookJourney: '🎟️ ಈ ಪ್ರಯಾಣ ಬುಕ್ ಮಾಡಿ',
  bookingJourney: '🎟️ ನಿಮ್ಮ ಪ್ರಯಾಣ ಬುಕ್ ಆಗುತ್ತಿದೆ...',
  journeyConfirmed: '✅ *ಪ್ರಯಾಣ ಬುಕ್ ಆಗಿದೆ!*',
  journeyLegsHeader: 'ನಿಮ್ಮ ಮಾರ್ಗ:',
  journeyCancelled: '✅ ಪ್ರಯಾಣ ರದ್ದಾಗಿದೆ.',
